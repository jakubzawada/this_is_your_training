...
class _AddTuesdayExerciseState extends State<AddTuesdayExercise> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TuesdayExerciseCubit(DocumentsRepository()),
      child: BlocListener<TuesdayExerciseCubit, TuesdayExerciseState>(
        ...
        child: BlocBuilder<TuesdayExerciseCubit, TuesdayExerciseState>(
