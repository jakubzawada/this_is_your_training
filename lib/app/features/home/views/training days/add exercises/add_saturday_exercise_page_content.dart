...
class AddSaturdayExercise extends StatelessWidget {
  AddSaturdayExercise({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider<SaturdayExerciseCubit>(
      ...
      child: BlocListener<SaturdayExerciseCubit, SaturdayExerciseState>(
        ...
        child: BlocBuilder<SaturdayExerciseCubit, SaturdayExerciseState>(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              onChanged: (newValue) {
                                context
                                    .read<SaturdayExerciseCubit>()
                                    .uploadName5(newValue);
                              },
                            ),
                          ),
                          ...
                          const SizedBox(height: 20),
                          ElevatedButton(
                            onPressed: (state.series5 != null &&
                                    state.repeat5 != null &&
                                    state.exerciseName5.isNotEmpty)
                                ? () {
                                    context
                                        .read<SaturdayExerciseCubit>()
                                        .addexercise(
                                          exerciseName: state.exerciseName5,
                                          repeat: state.repeat5!,
